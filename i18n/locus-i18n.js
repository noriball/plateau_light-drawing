...
(function (global) {
  ...
  const I18N = {
    ja: {
      ...
      'transport.volume': '音量',
      'transport.volumeTitle': '交点サウンドの音量',
      'transport.mute': '消音（音量は記憶）',
      'transport.unmute': '消音解除',
      'transport.axes': '軸表示',
    ...
    en: {
      ...
      'transport.volumeTitle': 'Intersection sound volume',
      'transport.mute': 'Mute (volume remembered)',
